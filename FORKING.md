...
Don't remove any credit to Scratch, TurboWarp, PenguinMod, Permafy, Snail-IDE, or GaiaMod. That's just not cool.  
...
The APIs are only built for PenguinMod and therefore will likely end up breaking in your mod at some point or another.

They also do not allow projects that only work outside of PenguinMod so if they end up having a lot of broken uploads from your site, then they'll have to block your site from being able to use the project API.
